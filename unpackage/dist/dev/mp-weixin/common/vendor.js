...
/***/ 1053:
/*!*******************************************!*\
  !*** D:/working/舒服康/common/specSelect.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.judgeSelect = void 0;
/*判断哪些规格可以选*/
var judgeSelect = function judgeSelect(list, _index, productSpecArr, productSku) {
  /*大类*/
  for (var i = 0, count = list.length; i < count; i++) {
    /*小类*/
    for (var j = 0; j < list[i].spec_items.length; j++) {
      var item = list[i].spec_items[j];
      if (i != _index) {
...
/*判断有没有规格ID*/
exports.judgeSelect = judgeSelect;
function hasSpecId(index, id, productSpecArr, productSku) {
  var disabled = false;
  var reg = '';
  for (var p = 0; p < productSpecArr.length; p++) {
    if (p != index) {
  ...
  for (var s = 0; s < productSku.length; s++) {
    var ids = productSku[s].join('_');
...
/***/ 1150:
/*!***********************************************************************!*\
  !*** D:/working/舒服康/uni_modules/almost-lottery/utils/almost-utils.js ***!
  \***********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.setStore = exports.pathToBase64 = exports.getStore = exports.downloadFile = exports.clearStore = exports.clearCacheFile = exports.clacTextLen = exports.base64ToPath = void 0;
...
/***/ 1453:
/*!**************************************************!*\
  !*** D:/working/舒服康/jweixin-module/out/index.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(wx, module) {var __WEBPACK_AMD_DEFINE_RESULT__;var _defineProperty = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11);
var _typeof = __webpack_require__(/*! @babel/runtime/helpers/typeof */ 13);
!function (e, n) {
  "object" == ( false ? undefined : _typeof(exports)) && "object" == ( false ? undefined : _typeof(module)) ? module.exports = n(e) :  true ? !(__WEBPACK_AMD_DEFINE_RESULT__ = (function () {
    return n(e);
  ...
  if (!o.jWeixin) {
    ...
    var A = !1,
        ...
        config: function config(e) {
          ...
          u(function () {
            if (t) c(p.config, {
              ...
              x.state = 1;
              for (var e = P._completes, n = 0, i = e.length; n < i; ++n) {
                e[n]();
              }
              P._completes = [];
            }
      ...
      }, _defineProperty(_C, "getLocation", function getLocation(e) {
        c(p.getLocation, {
          type: (e = e || {}).type || "wgs84"
        }, (e._complete = function (e) {
          delete e.type;
        }, e));
      }), _defineProperty(_C, "hideOptionMenu", function hideOptionMenu(e) {
        c("hideOptionMenu", {}, e);
      }), _defineProperty(_C, "showOptionMenu", function showOptionMenu(e) {
        c("showOptionMenu", {}, e);
      }), _defineProperty(_C, "closeWindow", function closeWindow(e) {
        c("closeWindow", {}, e = e || {});
      }), _defineProperty(_C, "hideMenuItems", function hideMenuItems(e) {
        c("hideMenuItems", {
          menuList: e.menuList
        }, e);
      }), _defineProperty(_C, "showMenuItems", function showMenuItems(e) {
        c("showMenuItems", {
          menuList: e.menuList
        }, e);
      }), _defineProperty(_C, "hideAllNonBaseMenuItem", function hideAllNonBaseMenuItem(e) {
        c("hideAllNonBaseMenuItem", {}, e);
      }), _defineProperty(_C, "showAllNonBaseMenuItem", function showAllNonBaseMenuItem(e) {
        c("showAllNonBaseMenuItem", {}, e);
      }), _defineProperty(_C, "scanQRCode", function scanQRCode(e) {
        c("scanQRCode", {
      ...
      }), _defineProperty(_C, "openAddress", function openAddress(e) {
      ...
      }), _defineProperty(_C, "openProductSpecificView", function openProductSpecificView(e) {
        c(p.openProductSpecificView, {
          pid: e.productId,
          view_type: e.viewType || 0,
          ext_info: e.extInfo
        }, e);
      }), _defineProperty(_C, "addCard", function addCard(e) {
      ...
      }), _defineProperty(_C, "chooseCard", function chooseCard(e) {
        c("chooseCard", {
          app_id: M.appId,
      ...
      }), _defineProperty(_C, "openCard", function openCard(e) {
        for (var n = e.cardList, i = [], t = 0, o = n.length; t < o; ++t) {
          var r = n[t],
            a = {
              card_id: r.cardId,
      ...
      }), _defineProperty(_C, "consumeAndShareCard", function consumeAndShareCard(e) {
        c(p.consumeAndShareCard, {
          consumedCardId: e.cardId,
          consumedCode: e.code
        }, e);
      }), _defineProperty(_C, "chooseWXPay", function chooseWXPay(e) {
        c(p.chooseWXPay, n(e), e);
      }), _defineProperty(_C, "openEnterpriseRedPacket", function openEnterpriseRedPacket(e) {
        c(p.openEnterpriseRedPacket, n(e), e);
      }), _defineProperty(_C, "startSearchBeacons", function startSearchBeacons(e) {
        c(p.startSearchBeacons, {
          ticket: e.ticket
        }, e);
      }), _defineProperty(_C, "stopSearchBeacons", function stopSearchBeacons(e) {
        c(p.stopSearchBeacons, {}, e);
      }), _defineProperty(_C, "onSearchBeacons", function onSearchBeacons(e) {
        i(p.onSearchBeacons, e);
      }), _defineProperty(_C, "openEnterpriseChat", function openEnterpriseChat(e) {
        c("openEnterpriseChat", {
          useridlist: e.userIds,
          chatname: e.groupName
        }, e);
      }), _defineProperty(_C, "launchMiniProgram", function launchMiniProgram(e) {
        c("launchMiniProgram", {
      ...
      }), _defineProperty(_C, "miniProgram", {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/wx.js */ 1)["default"], __webpack_require__(/*! ./../../../../HBuilderX/plugins/uniapp-cli/node_modules/webpack/buildin/module.js */ 1454)(module)))
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"舒服康智能穿戴","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var app_url = 'https://shufukang.87huotu.com';
// 如果是本地测试环境
if (true) {}
...
/***/ 35:
/*!******************************************!*\
  !*** D:/working/舒服康/common/directive.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ 4);
var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 25));
var defaultImg = __webpack_require__(/*! @/static/default.png */ 36);
...
/***/ 36:
/*!*****************************************!*\
  !*** D:/working/舒服康/static/default.png ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ 37:
/*!***************************************!*\
  !*** D:/working/舒服康/common/onfire.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 38:
/*!*****************************************!*\
  !*** D:/working/舒服康/common/gotopage.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*导航菜单白名单*/
var tabBarLinks = ['/pages/index/index', '/pages/product/category', '/pages/shop/middle', '/pages/cart/cart', '/pages/user/index/index'];

/*分享页面,扫码白名单*/
var shareLinks = ['/pages/plus/assemble/fight-group-detail/fight-group-detail', '/pages/plus/bargain/haggle/haggle', '/pages/user/invite/invite', '/pages/product/detail/detail'];
...
var _default = new _vuex.default.Store({
  ...
  mutations: {
    ...
    changePoints: function changePoints(state, value) {
...
var runtime = __webpack_require__(/*! @babel/runtime/helpers/regeneratorRuntime */ 744)();
...
/***/ 852:
/*!*********************************************************!*\
  !*** D:/working/舒服康/pages/user/my_shop/product_rule.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

<template>
  <!--
    ...
    描述：插件中心-直播-礼物-修改礼物
  -->
  <el-dialog title="修改礼物" :visible.sync="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false" :close-on-press-escape="false">
    <el-form size="small" :model="form" :rules="formRules" ref="form">
      ...
      <el-form-item label="商品图片" :label-width="formLabelWidth" :rules="[{ required: true, message: '请上传商品图片' }]" prop="image_id">
        <div class="gift-img-box d-c-c">
          ...
          <div class="gift-img-btn" @click="openProductUpload" v-else><i class="el-icon-plus"></i></div>
        </div>
      </el-form-item>

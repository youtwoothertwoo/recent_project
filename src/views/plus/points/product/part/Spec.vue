      ...
      <div class="pt16">
        <el-table size="mini" :data="form.tableData" :span-method="objectSpanMethod" border style="width: 100%;">
          ...
          <el-table-column label="兑换积分">
            <template slot-scope="scope">
              <el-input size="small" type="number" min="0" step="1" disabled v-model="scope.row.point_num"></el-input>
            </template>
          </el-table-column>
          <el-table-column label="兑换金额">
            <template slot-scope="scope">
              <el-form-item label="" style="margin-bottom: 0;">
                <el-input disabled size="small" type="number" min="0" step="0.01" v-model="scope.row.point_money"></el-input>
              </el-form-item>
            </template>
          </el-table-column>
          <el-table-column label="库存总量">
            <template slot-scope="scope">
              <el-form-item label="" style="margin-bottom: 0;">
                <el-input disabled size="small" type="number" min="0" step="1" v-model="scope.row.point_stock"></el-input>
              </el-form-item>
            </template>
          </el-table-column>
        </el-table>

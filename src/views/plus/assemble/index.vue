<template>
  ...
  <div class="common-seach-wrap">
    ...
    <!--基础设置-->
    <getSetting v-if="activeName == 'setting'"></getSetting>
	<!--审核记录-->
...
import Audit from "./product/index"
...
export default {
      ...
      sourceList: [
        {
          key: 'active',
          value: '拼团活动',
          path:'/plus/assemble/active/index'
        },
        {
          key: 'setting',
          value: '基础设置',
          path:'/plus/assemble/setting/index'
        },
        {
          key: 'audit',
          value: '审核记录',
          path:'/plus/assemble/product/index'
        },
      ],
      /*权限筛选后的数据*/
      tabList:[],
  ...
  beforeDestroy() {
    //发送类别切换
    bus.$emit('tabData', { active: null, tab_type:'assemble',list: [] });
    bus.$off('activeValue');
  },
  methods: {

      ...
      <el-form ref="form" :model="form" label-width="150px">
        ...
        <el-form-item label="活动日期">
          <div class="block">
            ...
            <el-date-picker v-model="form.value1" type="datetimerange"  value-format="yyyy-MM-dd" range-separator="至" start-placeholder="开始日期"
        ...
        <el-form-item label="邀请成功的条件 ">
          <el-radio v-model="form.inv_condition" label="1">邀请成为会员</el-radio>
        </el-form-item>
        <div class="common-form">礼品设置</div>
        <div v-for="(item,reward_index) in rewardData">
          <el-form-item label="奖励">
            <el-input type="number" v-model="item.invitation_num" class="max-w460">
              <template slot="prepend">每邀请</template>
              <template slot="append">人获得礼品</template>
            </el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        let self = this;
        let id = self.$route.query.invitation_gift_id;

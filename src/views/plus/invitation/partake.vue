    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table :data="tableData" border style="width: 100%" v-loading="loading">
          <el-table-column prop="invitation_gift_id" label="ID"></el-table-column>
          ...
          <el-table-column prop="partake.nickName" label="参与人"></el-table-column>
        </el-table>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      getTableList() {
        ...
        InvitationGiftApi.partakelist(Params, true).then(data => {
          console.log(data);
          self.loading = false;

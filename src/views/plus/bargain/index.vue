...
export default {
      ...
      sourceList: [
        {
          key: 'active',
          value: '活动列表',
          path:'/plus/bargain/active/index'
        },
        {
          key: 'task',
          value: '砍价记录',
          path:'/plus/bargain/task/index'
        },
        {
          key: 'setting',
          value: '砍价设置',
          path:'/plus/bargain/setting/index'
        },
        {
          key: 'audit',
          value: '审核记录',
          path:'/plus/bargain/product/index'
        },
      ],
      /*权限筛选后的数据*/
      tabList:[],
  ...
  beforeDestroy() {
    //发送类别切换
    bus.$emit('tabData', { active: null, tab_type:'bargain',list: [] });
    bus.$off('activeValue');
  },
  methods: {

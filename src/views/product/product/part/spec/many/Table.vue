    ...
    <div class="mt16">
      <el-form-item label="规格明细：" v-if="form.model.spec_many && form.model.spec_many.spec_list.length > 0">
        <div>
          ...
          <el-input size="small" v-model="batchData.subsidy_money" placeholder="补贴金额" style="width: 160px;padding-left: 4px;"></el-input>
          <el-input size="small" v-model="batchData.district_price" placeholder="区县价格" style="width: 160px;padding-left: 4px;"></el-input>
          <el-input size="small" v-model="batchData.shop_price" placeholder="店中店价格" style="width: 160px;padding-left: 4px;"></el-input>
          <el-input size="small" v-model="batchData.star_price" placeholder="星级价格" style="width: 160px;padding-left: 4px;"></el-input>
        ...
        <div >
          <el-table size="mini" :data="form.model.spec_many.spec_list" :span-method="objectSpanMethod" border style="width: 100%; margin-top: 20px">
            ...
            <el-table-column label="补贴金额">
              <template slot-scope="scope">
                <el-form-item label="" style="margin-bottom: 0;"><el-input size="small" prop="subsidy_money" v-model="scope.row.spec_form.subsidy_money"></el-input></el-form-item>
              </template>
            </el-table-column>
            <el-table-column label="区县价格">
              <template slot-scope="scope">
                <el-form-item label="" style="margin-bottom: 0;"><el-input size="small" prop="district_price" v-model="scope.row.spec_form.district_price"></el-input></el-form-item>
              </template>
            </el-table-column>
            <el-table-column label="店中店价格">
              <template slot-scope="scope">
                <el-form-item label="" style="margin-bottom: 0;"><el-input size="small" prop="shop_price" v-model="scope.row.spec_form.shop_price"></el-input></el-form-item>
              </template>
            </el-table-column>
            <el-table-column label="星级价格">
              <template slot-scope="scope">
                <el-form-item label="" style="margin-bottom: 0;"><el-input size="small" prop="star_price" v-model="scope.row.spec_form.star_price"></el-input></el-form-item>
              </template>
            </el-table-column>

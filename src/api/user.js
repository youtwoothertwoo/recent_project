...
let UserApi = {
    ...
    resetPay(data,errorback){
        return request._post('shop/user.user/reset',data,errorback)
    },
    
    fixRefer(data,errorback){
        return request._post('shop/user.user/updateReferee',data,errorback)
    }
}
